/**
 * H5 UI helpers: toast, XP float, level-up, header balances
 * Same API as c-end/js/ui.js so page scripts can mirror desktop logic.
 */
(function (global) {
  'use strict';
  ...
  function xpFloat(xpGain, x, y) {
    ...
    el.style.top = (y != null ? y : window.innerHeight / 2.4) + 'px';
  ...
  function showLevelUp(leveled) {
    ...
    if (leveled.form && leveled.form.name) {
      desc +=
        ' · 管家宠进化为「' + leveled.form.emoji + ' ' + leveled.form.name + '」！';
    }
